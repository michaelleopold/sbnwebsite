...
const HomeHeaderContent = () => (
  <div className="flex-grow flex flex-col justify-center items-center text-white">
    ...
    <h1 className="text-5xl md:text-[3.1rem] md:mb-1 lg:mb-0 lg:text-6xl font-bold">PUMPING SERVICES</h1>
    <h1 className="text-3xl md:text-[3.1rem] lg:text-6xl font-bold text-[#0094DF]">EXPERIENCED & PROFESSIONAL</h1>
